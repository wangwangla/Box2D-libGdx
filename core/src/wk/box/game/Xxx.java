...
public class Xxx extends ApplicationAdapter implements InputProcessor {
...
//                (int)mParticleSystem.calculateReasonableParticleIterations(Gdx.graphics.getDeltaTime()));

        mWorld.step(Gdx.graphics.getDeltaTime(), 10, 6,3);
