 ...
 *   车轮   小车
 */
public class Demo12 extends Group {
    private Utils utils;
    private Body box;
    Body box1;
    Body box2;
...
//        Constant.world.createJoint(def);
        ...
        WheelJointDef def1 = new WheelJointDef();
        def1.initialize(box2,body,box2.getPosition(),new Vector2(0,1));
        def1.frequencyHz = 3;
        def1.maxMotorTorque = 100;
        def1.motorSpeed = 100;
